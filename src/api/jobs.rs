...
use crate::{
    api::errors::ApiError, auth::user_identity::UserIdentity, dtos::job_dto::JobDto,
    entity::job::Job, repository::job_repository, AppState,
};
...
async fn create(
    ...
    let job: Job = body.into_inner().to_entity(identity.id);
